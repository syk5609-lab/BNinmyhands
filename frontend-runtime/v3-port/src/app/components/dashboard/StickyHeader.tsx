...
import { useNavigate, useLocation } from '../../preview-router';
import { Activity, Clock, Database, LogIn, Users, Shield, LayoutDashboard, ChevronDown, User } from '../../lucide';
...
export function StickyHeader({ ctx }: { ctx: RunContext }) {
  ...
  const navItems: NavItem[] = [
    ...
    { label: 'Community', path: '/community', icon: Users, show: flags.communityEnabled },
