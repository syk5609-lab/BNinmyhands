    ...
    <RebuildShell>
      ...
      {fixture.state === "ready" ? (
        <>
          ...
          <section className="rb-panel">
            <div className="rb-panel__inner">
              ...
              <div className="rb-card-grid">
                {fixture.topCandidates.map((candidate) => {
                  ...
                  return (
                    <Link className="rb-card" href={href} key={candidate.symbol}>
          ...
          <div>{ads === "on" ? <SponsorSlot sponsor={fixture.sponsors.top} /> : null}</div>

          <section className="rb-summary-grid">
            {fixture.bucketSummary.map((bucket) => (
              <div className="rb-summary" key={bucket.label}>
          ...
          <section className="rb-control-row">
          ...
          <div>{ads === "on" ? <SponsorSlot sponsor={fixture.sponsors.mid} /> : null}</div>
        </>
      ) : null}
      <DisclosureFooter />
    </RebuildShell>
